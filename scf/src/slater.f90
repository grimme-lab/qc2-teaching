...
module slater
    ...
    private
    public :: expand_slater

    integer, parameter :: wp = selected_real_kind(15)
    intrinsic :: atan, present, shape, reshape, sqrt
    ...
    real(wp), parameter :: pAlpha2(2, nf) = reshape([ &
        ...
        & 4.323908358e-1_wp, 1.069139065e-1_wp, & ! 2p
    ...
    real(wp), parameter :: pCoeff2(2, nf) = reshape([ &
        ...
        & 5.349653114e-1_wp, 5.299607212e-1_wp, & ! 3p
    ...
    real(wp), parameter :: pAlpha3(3, nf) = reshape([ &
        ...
        & 1.649233885e-1_wp, 7.487066646e-2_wp, 3.135787219e-2_wp, & ! 5f
    ...
    real(wp), parameter :: pCoeff3(3, nf) = reshape([ &
        ...
        &-2.010175008e-2_wp, 5.899310608e-1_wp, 4.658445960e-1_wp, & ! 5d
    ...
    real(wp), parameter :: pAlpha4(4, nf) = reshape([ &
        ...
        & 5.441006630e-2_wp, 3.037569283e-2_wp, &
        & 3.945205573e-1_wp, 1.588100623e-1_wp, & ! 5g
        & 7.646521729e-1_wp, 3.898703611e-2_wp],&
        & shape(pAlpha4))
    ...
    real(wp), parameter :: pAlpha5(5, nf) = reshape([ &
        ...
        & 5.531913898e-2_wp, 3.072866652e-2_wp, &
    ...
    real(wp), parameter :: pCoeff5(5, nf) = reshape([ &
        ...
        & 2.079051117e-2_wp, 1.235472099e-1_wp, 3.667738986e-1_wp, & ! 2p
        ...
        & 5.693674316e-1_wp, 1.511340183e-1_wp, &
    ...
    real(wp), parameter :: pAlpha6(6, nf) = reshape([ &
        ...
        & 1.559114463e-1_wp, 7.817734732e-2_wp, 4.058484363e-2_wp, &
        ...
        & 1.334096840e+0_wp, 2.372312347e-1_wp, 1.269485144e-1_wp, & ! 5f
        & 7.290318381e-2_wp, 4.351355997e-2_wp, 2.598071843e-2_wp, &
        & 8.574668996e-1_wp, 3.497184772e-1_wp, 1.727917060e-1_wp, & ! 5g
        & 9.373643151e-2_wp, 5.340032759e-2_wp, 3.051364464e-2_wp],&
        & shape(pAlpha6))
    ...
    real(wp), parameter :: pCoeff6(6, nf) = reshape([ &
        ...
        &-4.097311019e-3_wp,-2.508271857e-2_wp, 2.648458555e-1_wp, & ! 5d
...
pure subroutine expand_slater(ng, zeta, alpha, coeff)
